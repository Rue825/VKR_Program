...
namespace Melans_LLC
{
    public partial class MainWindow : Form
    {
        ...
        Reg_Info _RI = new Reg_Info(); //Доступ к реестру
        Dlya_Administratora _DA = new Dlya_Administratora(); //Доступ для администратора
        ...
        private void bunifuFlatButton1_Click(object sender, EventArgs e)
        {
            ...
            switch (MetroFramework.MetroMessageBox.Show(this, "Завершить работу приложения?", "Melanc_LLC", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
                case DialogResult.Yes:
                    ...
                    //MetroFramework.MetroMessageBox.Show(this, Program.Status_RegPolzOsv+" "+Program.Status_RegPolzZav+" "+Program.Auth_Polz, "Melanc_LLC", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    _RI.Reg_Shifr(Program.Log_Polz, Program.Pass_Polz);
                    Application.Exit();
                    break;
        ...
        {
            Uslugi_Form _U = new Uslugi_Form();
            _U.ShowDialog();
        }
