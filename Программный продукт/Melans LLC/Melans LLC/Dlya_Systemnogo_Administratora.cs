...
namespace Melans_LLC
{
    public partial class Dlya_Systemnogo_Administratora : MetroFramework.Forms.MetroForm
    {
        ...
        public Dlya_Systemnogo_Administratora()
        {
            InitializeComponent();
        ...
        private void Dlya_Systemnogo_Administratora_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "melans_LLCDataSet.Systemni_administrator". При необходимости она может быть перемещена или удалена.
            this.systemni_administratorTableAdapter.Fill(this.melans_LLCDataSet.Systemni_administrator);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "melans_LLCDataSet.Technika". При необходимости она может быть перемещена или удалена.
            this.technikaTableAdapter.Fill(this.melans_LLCDataSet.Technika);
        ...
        private void metroGrid7_Click(object sender, EventArgs e)
        {
            ...
            metroDateTime3.Text = metroGrid7.CurrentRow.Cells[2].Value.ToString();
            metroDateTime2.Text = metroGrid7.CurrentRow.Cells[3].Value.ToString();
            metroComboBox8.SelectedValue = metroGrid7.CurrentRow.Cells[4].Value.ToString();
            metroComboBox6.SelectedValue = metroGrid7.CurrentRow.Cells[5].Value.ToString();
            metroComboBox5.SelectedValue = metroGrid7.CurrentRow.Cells[6].Value.ToString();
            metroComboBox4.SelectedValue = metroGrid7.CurrentRow.Cells[7].Value.ToString();
        }
        ...
        private void metroGrid9_Click(object sender, EventArgs e)
        {
            ...
            metroComboBox10.SelectedValue = metroGrid9.CurrentRow.Cells[4].Value.ToString();
        }

        private void metroGrid15_Click(object sender, EventArgs e)
        {
            metroTextBox15.Text = metroGrid15.CurrentRow.Cells[1].Value.ToString();
            metroTextBox14.Text = metroGrid15.CurrentRow.Cells[2].Value.ToString();
            metroTextBox13.Text = metroGrid15.CurrentRow.Cells[3].Value.ToString();
        }
        ...
        private void metroButton7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _CB.InsertZayavk(metroTextBox16.Text, metroDateTime1.Text, metroDateTime4.Text, Convert.ToInt32(metroComboBox1.SelectedValue), Convert.ToInt32(metroComboBox2.SelectedValue), Convert.ToInt32(metroComboBox3.SelectedValue), Convert.ToInt32(metroComboBox7.SelectedValue));
        ...
        private void metroButton8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _CB.EditZayavk(Convert.ToInt32(metroGrid7.CurrentRow.Cells[0].Value.ToString()), metroTextBox1.Text, metroDateTime3.Text, metroDateTime2.Text, Convert.ToInt32(metroComboBox8.SelectedValue), Convert.ToInt32(metroComboBox6.SelectedValue), Convert.ToInt32(metroComboBox5.SelectedValue), Convert.ToInt32(metroComboBox4.SelectedValue));
                    _CB.UpdateZayavk(metroGrid7);
                }
            }
            catch (Exception ex)
        ...
        private void metroButton10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _CB.InsertTech(metroTextBox19.Text, metroDateTime6.Text, metroDateTime5.Text, Convert.ToInt32(metroComboBox9.SelectedValue));
        ...
        private void metroButton11_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _CB.EditTech(Convert.ToInt32(metroGrid9.CurrentRow.Cells[0].Value.ToString()), metroTextBox20.Text, metroDateTime8.Text, metroDateTime7.Text, Convert.ToInt32(metroComboBox10.SelectedValue));
                    _CB.UpdateTech(metroGrid9);
                }
            }
            catch (Exception ex)
        ...
        private void metroButton4_Click(object sender, EventArgs e)
        {
            try
            {
                if (metroTextBox12.Text == string.Empty || metroTextBox11.Text == string.Empty || metroTextBox10.Text == string.Empty)
                {
                    MetroFramework.MetroMessageBox.Show(this, "Поля должны быть все заполнены!", "Melans LLC", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    _CB.InsertSysAdmin(metroTextBox12.Text, metroTextBox11.Text, metroTextBox10.Text);
        ...
        private void metroButton5_Click(object sender, EventArgs e)
        {
            try
            {
                if (metroTextBox15.Text == string.Empty || metroTextBox14.Text == string.Empty || metroTextBox13.Text == string.Empty)
                {
                    MetroFramework.MetroMessageBox.Show(this, "Поля должны быть все заполнены!", "Melans LLC", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    _CB.EditSysAdmin(Convert.ToInt32(metroGrid15.CurrentRow.Cells[0].Value.ToString()), metroTextBox15.Text, metroTextBox14.Text, metroTextBox13.Text);
                    _CB.UpdateSysAdmin(metroGrid15);
                }
            }
            catch (Exception ex)
