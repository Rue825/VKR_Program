    ...
    public partial class Korzina : MetroFramework.Forms.MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _CB.CreateZayavk(metroTextGenerateNumZayavk.Text, metroTextBoxDate.Text, metroTextBoxTime.Text, Convert.ToInt32(metroComboBox2.SelectedValue), Convert.ToInt32(metroTextBoxKlient_ID.Text), Convert.ToInt32(metroComboBox1.SelectedValue), Convert.ToInt32(metroTextBoxUslug_ID.Text));
