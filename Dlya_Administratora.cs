...
namespace Melans_LLC
{
    public partial class Dlya_Administratora : MetroFramework.Forms.MetroForm
    {
        ...
        private void Dlya_Administratora_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "melans_LLCDataSetNewVariant.Doljnost". При необходимости она может быть перемещена или удалена.
            this.doljnostTableAdapter1.Fill(this.melans_LLCDataSetNewVariant.Doljnost);
        ...
        private void metroGrid18_Click(object sender, EventArgs e)
        {
            ...
            metroDateTime4.Text = metroGrid18.CurrentRow.Cells[11].Value.ToString();
            metroDateTime1.Text = metroGrid18.CurrentRow.Cells[12].Value.ToString();
            metroComboBox7.SelectedValue = metroGrid18.CurrentRow.Cells[14].Value.ToString();
        }
            ...
            {   
                ...
                if (matched == true)
                {
                    ...
                    else
                    {
                        ...
                        {
                            _CB.InsertRegPolz(metroTextBox1.Text, metroTextBox5.Text, metroTextBox6.Text, metroTextBox7.Text, maskedTextBox1.Text, metroTextBox9.Text, metroTextBox10.Text, Convert.ToInt32(metroComboBox5.SelectedValue), Convert.ToInt32(metroComboBox1.SelectedValue), "Свободен","09:00","19:00","0",Convert.ToInt32(metroComboBox4.SelectedValue));
        ...
        private void MetroCheckBox1_Click(object sender, EventArgs e)
        {
            ...
            {
                _CB.UpdateFiltrRegPolzInj(metroGrid18);
            }
            else
            {
                _CB.UpdateRegPolz(metroGrid18);
        ...
        {
           _CB.SortirovkaZA(metroGrid18);
        }

        private void MetroButton20_Click(object sender, EventArgs e)
        {
           _CB.SortirovkaAZ(metroGrid18);
        }

        private void MetroButton21_Click(object sender, EventArgs e)
        {
            ReportOtchet _RO = new ReportOtchet();
            _RO.metroTabPage2.Parent = null;
            _RO.ShowDialog();
        }
    }
}
